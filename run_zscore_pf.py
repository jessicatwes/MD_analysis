...
from zscore_lib import zscore_conv

# set pathway
indir = '/Users/jewe1055/experiments/exp78/output/'
outdir = '/Users/jewe1055/experiments/exp78/output/RUNX1_Tfit2016/'
...
# read csv file
with open(indir+md_table_file) as csvfile:
...
with open(outdir+zscore_table_file, 'w', encoding='UTF8', newline='') as f:
...
# for md
draft_categorize_msd_file_into_tf_regulation(indir+md_table_file, outdir+md_tfpf_file)
# for z-score
draft_categorize_msd_file_into_tf_regulation(outdir+zscore_table_file, outdir+zscore_tfpf_file)
