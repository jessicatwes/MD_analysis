...
#### File paths
#outDir = "/Users/jewe1055/experiments/exp73/output/"
#mufile = "/Shares/dbnascent/Wang2020increased/tfit/prelim/SRZ10466082.sorted-1_prelim_bidir_hits.bed"
...
motifname <- strsplit(motifname, split ='_')
motifname <- sapply(motifname, head, 1)
...
# Create empty dataframe in range -1500 to 1500 initialize with 0
Var1 = as.character(seq(-1500, 1500, 1))
